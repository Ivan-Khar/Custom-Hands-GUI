...
public class Registrations {
	...
	public static void init() {
		...
		keyBindings[0] = new KeyBinding("key.aqupd.changehands", Keyboard.KEY_H, "key.aqupd.categories.handgui");
		keyBindings[1] = new KeyBinding("key.aqupd.configgui", Keyboard.KEY_G, "key.aqupd.categories.handgui");
		keyBindings[2] = new KeyBinding("key.aqupd.resethands", Keyboard.KEY_K, "key.aqupd.categories.handgui");
